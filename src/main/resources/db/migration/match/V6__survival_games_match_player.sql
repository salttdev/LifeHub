...
CREATE TABLE survival_games_match_player (
    ...
    -- Not carried by MatchResult yet; written null until the protocol grows them.
    team_uuid       CHAR(36),
    cause_of_death  VARCHAR(255),

    PRIMARY KEY (match_id, player_uuid),
    FOREIGN KEY (match_id, player_uuid) REFERENCES match_player_stats(match_id, player_uuid)
);
